...
image: '/images/sparticle-engine_b_1440x1600.png'
---
<h1>Basic Info</h1>
<ul>
  <li><b>Project:</b> Sparticle Engine</li>
  <li><b>Role:</b> Solo Developer</li>
  <li><b>Timeline:</b> October 2025 - December 2025</li>
</ul>

<h1>Key Contributions</h1>
• Built standalone game engine with low-level systems in modern C++, CMake, and SDL3<br>
• Implemented rendering, animation, input, resource management, components, and navigation<br>

<p>
  <a href="https://github.com/ackleyrc/2D-Game-Engine">
    <h2 class="project__nav__title">Code on GitHub</h2>
  </a>
</p>
